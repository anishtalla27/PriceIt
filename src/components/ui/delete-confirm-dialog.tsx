  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-sm rounded-2xl border border-[#F0B5A3] bg-white px-5 py-5 shadow-[0_24px_60px_rgba(50,50,93,0.24)]"
        onMouseDown={(event) => event.stopPropagation()}
      >
        <h2 id="delete-confirm-title" className="text-xl font-extrabold text-[#2B2B2B]">
          Delete {displayName}?
        </h2>
        <p className="mt-2 text-sm leading-relaxed text-[#4F747C]">
        ...
        <div className="mt-5 flex flex-col-reverse gap-2 sm:flex-row sm:justify-end">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className="min-h-11 rounded-xl bg-[#E1603F] px-4 py-2 text-sm font-bold text-white transition hover:bg-[#C94E32]"
          >
            Delete
          </button>
        </div>

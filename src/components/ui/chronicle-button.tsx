...
.chronicleButton:hover:not(:disabled) {
...
.chronicleButton:hover:not(:disabled) span:nth-of-type(1) em {
  opacity: 0;
  transform: rotateX(90deg) scaleX(.9) translate3d(0,-10px,0);
}
.chronicleButton:hover:not(:disabled) span:nth-of-type(2) em {
  opacity: 1;

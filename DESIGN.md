...
### Primary
- **Stripe Purple** (`#5DB7C4`): Primary brand color, CTA backgrounds, link text, interactive highlights. A saturated blue-violet that anchors the entire system.
...
### Interactive
- **Primary Purple** (`#5DB7C4`): Primary link color, active states, selected elements.
- **Purple Hover** (`#5DB7C4`): Darker purple for hover states on primary elements.
- **Purple Deep** (`#5DB7C4`): `--hds-color-button-ui-iconHover`. Dark purple for icon hover states.
- **Purple Light** (`#5DB7C4`): `--hds-color-action-bg-subduedHover`. Soft lavender for subdued hover backgrounds.
- **Purple Mid** (`#5DB7C4`): `--hds-color-input-selector-text-range`. Range selector and input highlight color.
...
- **Border Purple** (`#5DB7C4`): Active/selected state borders on buttons and inputs.
- **Border Soft Purple** (`#5DB7C4`): Subtle purple-tinted borders for secondary elements.
- **Border Magenta** (`#ffd7ef`): Pink-tinted borders for magenta-themed elements.
- **Border Dashed** (`#5DB7C4`): Dashed borders for drop zones and placeholder elements.
...
- Padding: 8px 16px
- Radius: 4px
- Border: `1px solid #5DB7C4`
- Font: 16px sohne-var weight 400, `"ss01"`
- Hover: background shifts to `rgba(93,183,196,0.05)`
...
- Radius: 4px
- Focus: `1px solid #5DB7C4` or purple ring
...
### Decorative Elements
**Dashed Borders**
- `1px dashed #5DB7C4` (purple) for placeholder/drop zones
...
| Ring (Accessibility) | `2px solid #5DB7C4` outline | Keyboard focus ring |
...
- Use `#5DB7C4` purple as the primary interactive/CTA color
...
- "Create navigation: white sticky header with backdrop-filter blur(12px). sohne-var 14px weight 400 for links, #061b31 text, 'ss01'. Purple CTA 'Start now' right-aligned (#5DB7C4 bg, white text, 4px radius). Nav container 6px radius."
